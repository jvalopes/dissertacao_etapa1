...
# Campinas masc 2014
setwd('C:/Users/User/Documents/dissertacao_etapa1/raw_data/Campinas/tabnet_Campinas/.csv_m')

cps_2014 <- read_delim("campinas_2014_masc.csv", 
                       delim = ";", escape_double = FALSE, trim_ws = TRUE, 
                       skip = 4)

df <- cps_2014[-nrow(cps_2014), -23] # removendo 'total' e as ultimas linhas
...
df2 <- df %>% 
  select('cid10',
         ...
         '75-79', '80-84', '85-89', '90-94', '95-99', '100e+') %>%
...
setwd('C:/Users/User/Documents/dissertacao_etapa1/analysis_Campinas/campinas_tabnet/masc')
export(df5, "cps2014_masc_c.xlsx")
