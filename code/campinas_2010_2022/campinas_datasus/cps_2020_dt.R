...
# Campinas 2020 (datasus)
setwd('C:/Users/User/Documents/dissertacao_etapa1/raw_data/Campinas/tabnet_datasus/.csv')

cps_2020 <- read_delim("campinas_2020_dt.csv", 
                       delim = ";", escape_double = FALSE, trim_ws = TRUE, 
                       skip = 4)

df <- cps_2020[-c(465:472), -23] # removendo 'total' e as ultimas linhas
...
df5$'10 a 14 anos' <- c(NA, NA, NA, NA, NA) # inserindo a coluna, apesar dos NAs, para manter o padrao do df
df5 <- df5 %>% relocate('10 a 14 anos', .after = '5 a 9 anos')
df5 <- df5 %>% relocate('15 a 19 anos', .after = '10 a 14 anos')

setwd('C:/Users/User/Documents/dissertacao_etapa1/analysis_Campinas/campinas_datasus')
export(df5, "cps2020_dt_c.xlsx")
