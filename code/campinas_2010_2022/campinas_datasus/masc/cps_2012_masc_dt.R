...
# Campinas masc 2012 (datasus)
setwd('C:/Users/User/Documents/dissertacao_etapa1/raw_data/Campinas/tabnet_datasus/.csv_m')

cps_2012 <- read_delim("campinas_2012_dt_masc.csv", 
                       delim = ";", escape_double = FALSE, trim_ws = TRUE, 
                       skip = 5)

# removendo 'total' e as ultimas linhas
df <- cps_2012 %>%
  slice(1:(nrow(cps_2012) - 8)) %>%
  select(-ncol(cps_2012))
...
df <- df %>% mutate_at(c
                       ('0 a 6 dias', '7 a 27 dias', '28 a 364 dias', '1 a 4 anos',
                         ...
                         '80 anos e mais'), as.numeric, NA) # convertendo as idade para 'numeric'
...
setwd('C:/Users/User/Documents/dissertacao_etapa1/analysis_Campinas/campinas_datasus/masc')
export(df5, "cps2012_masc_dt_c.xlsx")
