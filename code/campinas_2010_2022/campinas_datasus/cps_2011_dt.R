...
# Campinas 2011 (datasus)
setwd('C:/Users/User/Documents/dissertacao_etapa1/raw_data/Campinas/tabnet_datasus/.csv')

cps_2011 <- read_delim("campinas_2011_dt.csv", 
                       delim = ";", escape_double = FALSE, trim_ws = TRUE, 
                       skip = 4)

df <- cps_2011[-c(454:461), -22] # removendo 'total' e as ultimas linhas
