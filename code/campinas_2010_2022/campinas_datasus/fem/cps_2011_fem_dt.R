...
# Campinas fem 2011 (datasus)
setwd('C:/Users/User/Documents/dissertacao_etapa1/raw_data/Campinas/tabnet_datasus/.csv_f')

cps_2011 <- read_delim("campinas_2011_dt_fem.csv", 
...
setwd('C:/Users/User/Documents/dissertacao_etapa1/analysis_Campinas/campinas_datasus/fem')
export(df5, "cps2011_fem_dt_c.xlsx")
