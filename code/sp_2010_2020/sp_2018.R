...
sp_2018 <- read_delim("sp_2018_dt.csv", 
                      delim = ";", escape_double = FALSE, trim_ws = TRUE, 
                      skip = 4)

# nota: 2018, assim como alguns anos posteriores, nao possui o grupo <1 com idade ign
df <- sp_2018[-c(1117:1124), -23] # removendo 'total' e as ultimas linhas
