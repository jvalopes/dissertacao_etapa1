...
sp_2015 <- read_delim("sp_2015_dt.csv", 
                      delim = ";", escape_double = FALSE, trim_ws = TRUE, 
                      skip = 4)

# nota: 2015, assim como alguns anos posteriores, nao possui o grupo <1 com idade ign
df <- sp_2015[-c(1127:1136), -23] # removendo 'total' e as ultimas linhas
