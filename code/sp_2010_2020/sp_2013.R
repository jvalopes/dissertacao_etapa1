...
sp_2013 <- read_delim("sp_2013_dt.csv", 
                      delim = ";", escape_double = FALSE, trim_ws = TRUE, 
                      skip = 4)

# nota: 2013, assim como alguns anos posteriores, nao possui o grupo <1 com idade ign
df <- sp_2013[-c(1130:1137), -23] # removendo 'total' e as ultimas linhas
