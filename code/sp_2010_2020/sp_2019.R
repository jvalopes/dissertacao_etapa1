...
sp_2019 <- read_delim("sp_2019_dt.csv", 
                      delim = ";", escape_double = FALSE, trim_ws = TRUE, 
                      skip = 4)

# nota: 2019, assim como alguns anos posteriores, nao possui o grupo <1 com idade ign
df <- sp_2019[-c(1136:1145), -23] # removendo 'total' e as ultimas linhas
