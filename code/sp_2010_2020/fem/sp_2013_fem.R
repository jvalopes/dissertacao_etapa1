...
# SP fem 2013
setwd('C:/Users/User/Documents/dissertacao_etapa1/raw_data/Estado São Paulo/.csv_f')

sp_2013 <- read_delim("sp_2013_dt_fem.csv", 
                      delim = ";", escape_double = FALSE, trim_ws = TRUE, 
                      skip = 5)

df <- sp_2013[-c(952:nrow(sp_2013)), -23] # removendo 'total' e as ultimas linhas
...
setwd('C:/Users/User/Documents/dissertacao_etapa1/analysis_SP/fem')
export(df5, "sp2013_fem_c.xlsx")
