...
# SP masc 2020
setwd('C:/Users/User/Documents/dissertacao_etapa1/raw_data/Estado São Paulo/.csv_m')

sp_2020 <- read_delim("sp_2020_dt_masc.csv", 
                      delim = ";", escape_double = FALSE, trim_ws = TRUE, 
                      skip = 5)

df <- sp_2020[-c(969:nrow(sp_2020)), -24] # removendo 'total' e as ultimas linhas

df <- df %>% mutate_at(c
                       ('0 a 6 dias', '7 a 27 dias', '28 a 364 dias', '1 a 4 anos', 'Menor 1 ano (ign)',
...
setwd('C:/Users/User/Documents/dissertacao_etapa1/analysis_SP/masc')
export(df5, "sp2020_masc_c.xlsx")
