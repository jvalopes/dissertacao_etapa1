...
sp_2014 <- read_delim("sp_2014_dt.csv", 
                      delim = ";", escape_double = FALSE, trim_ws = TRUE, 
                      skip = 4)

# nota: 2014, assim como alguns anos posteriores, nao possui o grupo <1 com idade ign
df <- sp_2014[-c(1116:1123), -23] # removendo 'total' e as ultimas linhas
